...
Quick wins: source copy isolation, explicit job states, local runtime validation, safe errors, and persisted edit decisions. Deeper work: startup recovery, disk-space checks, job checkpointing, and restore tests. Risk: high.
